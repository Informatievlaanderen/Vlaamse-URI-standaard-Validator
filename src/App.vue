                    ...
                    <vl-column width="3">
                        <vl-side-navigation class="example-sticky" title="Documentatie">
                            <vl-side-navigation-list>
                                <vl-side-navigation-item href="#item3" text="Vlaamse URI-standaard voor data" />
                                <vl-side-navigation-item href="#item4" text="URI-richtlijnen voor data.vlaanderen.be" />
                            </vl-side-navigation-list>
                        </vl-side-navigation>
                    </vl-column>
                </vl-grid>
